...
const exerciseSchema = new Schema({
  type: {
    type: String,
    enum: ["resistance", "cardio", "flexability", "strength"],
    required: "Valid options are 'resistance' or 'cardio' or 'strength 'or' flexability'",
  },
  name: {
    type: String,
    trim: true,
  ...
  weights: {
    type: Number,
    required: isRequired("weights"),
  },
  nooftimes: {
    type: Number,
    required: isRequired("nooftimes"),
  },
  reps: {
    type: Number,
